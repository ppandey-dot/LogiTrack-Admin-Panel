...
?>
 ...
 <?php
$get_id=$_GET['id'];
$query2="SELECT * from truck_load_point where load_id='$get_id'";
    ...
    <div id="main-wrapper">
       ...
       <div class="content-body">
			...
			<div class="page-titles">
				<ol class="breadcrumb">
					<li><h5 class="bc-title">Edit Truck Load Point </h5></li>
			...
			<div class="col-xl-6 col-lg-12">
			  <div class="card">
				...
				<div class="card-header">
                                <h4 class="card-title">Edit Truck Load Point </h4>
                            </div>
			  ...
			  <form action="" method="POST" enctype="multipart/form-data">
							...
							<label class="form-label"> Truck Load Point Name<span class="text-danger">*</span></label>
							<input type="text" name="truck_load" class="form-control" placeholder=""value ="<?php echo $result2['truck_load_point'];?>">
                            </div>
				...
				<button type="submit" name="update" class="btn btn-primary">Update Truck Load Point</button></div>
						</div>
...
$query1="UPDATE truck_load_point set  truck_load_point='$truck_load',truck_route_id='$truck_route_id',status='$status' where load_id='$get_id'";

$smtp1=$conn->prepare($query1);

if($smtp1->execute()){
     echo "<script>alert('Updated!!');</script>";
	echo "<script>window.location='truck_load.php'</script>";
}
