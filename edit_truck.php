...
?>
 ...
 <?php
$get_id=$_GET['id'];
$query2="SELECT * from truck where truck_id_number='$get_id'";
    ...
    <div id="main-wrapper">
       ...
       <div class="content-body">
			...
			<div class="page-titles">
				<ol class="breadcrumb">
					<li><h5 class="bc-title">Edit Truck </h5></li>
			...
			<div class="col-xl-6 col-lg-12">
			  ...
			  <form action="" method="POST" enctype="multipart/form-data">
			               ...
			               <label class="form-label">Truck Number<span class="text-danger">*</span></label>
							<input value="<?php echo $result2['truck_number'];?>" type="text" name="truck_number" class="form-control" placeholder="" >
						</div>
							
							<div class="col-md-12 mb-3" >
							<label class="form-label"> Truck Capacity<span class="text-danger">*</span></label>
							<input type="text" name="truck_capacity" class="form-control" placeholder=""value ="<?php echo $result2['truck_capacity'];?>">
                            </div>

                              <div class="col-md-12 mb-3">
							<label class="form-label">Truck Photo<span class="text-danger">*</span></label>


                              
							<input value="<?php echo $result2['truck_photo'];?>"  type="file" name="image" class="form-control" style="margin-bottom:10px;" 
                              >
                               	<?php 
								if($result2['truck_photo']==''){
									echo '';
								}else{?>
								<img  src="images/<?php echo $result2['truck_photo'];?>" width="400px;" >
							...
							<label class="control-label">Truck Owner</label>
										<select name="truck_owner_id_number" class="form-control" required="required">

                                       <?php 
					$tOwnerID=$result2['truck_owner_id_number'];
                 ...
                 <?php while($result=$smtp->fetch()){?>
							...
							<div class="col-md-12 mb-3">
										...
										<select name="status"  class="form-control" required="required">
											...
											<option value="Active" <?php if($result2['truck_status']=='Active'){echo "selected";} ?>>Active</option>
											<option value="Inactive" <?php if($result2['truck_status']=='Inactive') {echo "selected";} ?>>Inactive</option>
										</select>
										</div>
										<div class="col-md-12 mb-3">
										<!--<button type="button" class="btn btn-danger light" data-bs-dismiss="">Close</button>-->
				<button type="submit" name="update" class="btn btn-primary">Update Truck</button></div>
						</div>
...
$truck_owner_id_number=$_POST['truck_owner_id_number'];
...
if($file_name == ''){
	$unique_image=$result2['truck_photo'];
}


$query1="UPDATE truck set truck_number='$truck_number', truck_capacity='$truck_capacity',truck_photo='$unique_image',truck_owner_id_number='$truck_owner_id_number',truck_route_id='$truck_route_id',truck_status='$status' where truck_id_number='$get_id'";

$smtp1=$conn->prepare($query1);
if($smtp1->execute()){
	 echo "<script>alert('Updated!!');</script>";
	echo "<script>window.location='truck.php'</script>";
}
